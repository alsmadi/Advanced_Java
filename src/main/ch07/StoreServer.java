...
import solutions.ch07solutions.Item;
import solutions.ch07solutions.Store;
import solutions.ch07solutions.ItemImpl;
...
public class StoreServer extends UnicastRemoteObject
    implements Store {
  ...
  public Attendant getAttendant() throws RemoteException {
    return new AttendantServer(this);
  }
