...
/**
 * This class bootstraps our RMI services for testing purposes.
 * In our production environment, these services will be started
 * individually on their respective servers.
 */
public class Server {
