  ...
  private void initWindow() {
      ...
      public void actionPerformed(ActionEvent ae) {
        ...
        if (className != null && !className.equals("")) {
          try {
            ...
            lstClasses.setListData(classes);
          }
          catch (Exception e) {
    ...
    button.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent ae) {
        ...
        if (className != null)
          lstCtors.setListData(engine.getCtors(className));
      }
    });
    content.add(button);
    ...
    button.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent ae) {
        ...
        if (ctor != null) {
          ...
          lstObjects.setListData(objects);
        }
        else {
          JOptionPane.showMessageDialog(ReflectFrame.this,
    ...
    button.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent ae) {
        ...
        if (o != null) {
          lstMethods.setListData(engine.getMethods(o));
        }
        else {
          JOptionPane.showMessageDialog(ReflectFrame.this,
